    ...
    return(
        <div className='flex flex-col w-screen h-screen p-[5%] pt-14 sm:p-[5%]' >
            ...
            <div className='flex flex-col sm:flex-row w-full h-screen mt-14' >
                <a href='/points' className='w-fit sm:w-[100%]'><div className='flex flex-col w-full h-fit sm:w-[30%] border-2 rounded-2xl border-violet-900 p-8 mt-5 sm:mr-5 mr-0 text-violet-900 hover:bg-violet-900 hover:text-white hover:cursor-pointer' >
